...
public class AdapterMyRoomList extends ArrayAdapter<Room> {
    public AdapterMyRoomList(Context context, ArrayList<Room> rooms) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.my_room_item, parent, false);
        }
        // Population Room
        ...
        TextView privacy1 = (TextView) convertView.findViewById(R.id.privacy1);
        privacy1.setText("Privacidade: " + room.getPrivacy());
